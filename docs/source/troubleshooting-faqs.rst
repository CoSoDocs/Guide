...
#. You are on an unsupported browser or device. `Click Here <https://coso-userguide.readthedocs.io/en/latest/getting-started.html#requirements>`_ for a list of requirements for using CounterSocial. 
...
**Is there a way to switch CounterSocial to a light background?**
	**A:** Custom themeing is not available at this time. `Click here <https://coso-userguide.readthedocs.io/en/latest/accessibility.html#light-dark-mode>`_ for information about using the Dark Reader extention as a possible solution.
...
**When I upload my image/video/gif, it doesn't attach to the post. What's the problem?**
	**A:** It's likely you are uploading media over the maximum allowable sizes of 8MB for images and 40MB for audio/video, or are uploading an unsupported file type. `Click Here <https://coso-userguide.readthedocs.io/en/latest/posting-content.html#editing-media>`_ to learn more about sharing image and video files. 
